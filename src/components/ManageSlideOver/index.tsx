...
const messages = defineMessages({
  ...
  manageModalMedia4k: 'NOW Library Media',
  ...
  openarr: 'Open in {arr}',
  openarr4k: 'Open in NOW Library {arr}',
  downloadstatus: 'Downloads',
  markavailable: 'Mark as Available',
  mark4kavailable: 'Mark as Available in NOW Library',
  markallseasonsavailable: 'Mark All Seasons as Available',
  markallseasons4kavailable: 'Mark All Seasons as Available in NOW Library',
