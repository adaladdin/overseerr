...
const messages = defineMessages({
  ...
  create4kradarr: 'Add New NOW Library Radarr Server',
  editradarr: 'Edit Radarr Server',
  edit4kradarr: 'Edit NOW Library Radarr Server',
  ...
  default4kserver: 'Default NOW Library Server',
